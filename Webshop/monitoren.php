...
<body>
            ...
            <div class="navbar-nav">
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item active" href="monitoren.php">Monitoren</a>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 item">
                <h4>MSI Gaming Optix MAG27CQ</h4>
                <img class="" src="Images/msi-gaming-optix-mag27cq.jpg" alt="" width="240" height="240">
                <h5>€ 599,00</h5>
                <p><a class="btn btn-success" href="login.php" role="button">In Winkelmandje</a></p>
            </div>
            <div class="col-lg-4 col-md-6 item">
                <h4>Acer Predator XB281HKbmiprz</h4>
                <img class="" src="Images/acer-predator-xb281hkbmiprz.jpg" alt="" width="240" height="240">
                <h5>€ 529,00</h5>
                <p><a class="btn btn-success" href="login.php" role="button">In Winkelmandje</a></p>
            </div>
            ...
            <div class="col-lg-4 col-md-6 item">
                <h4>Acer ET271bi</h4>
                <img class="" src="Images/acer-et271bi.jpg" alt="" width="240" height="240">
                <h5>€ 179,00</h5>
                <p><a class="btn btn-success" href="login.php" role="button">In Winkelmandje</a></p>
            </div>
            <div class="col-lg-4 col-md-6 item">
                <h4>Acer Gaming KG241Pbmidpx</h4>
                <img class="" src="Images/acer-gaming-kg241pbmidpx.jpg" alt="" width="240" height="240">
                <h5>€ 199,99</h5>
                <p><a class="btn btn-success" href="login.php" role="button">In Winkelmandje</a></p>
            </div>
            <div class="col-lg-4 col-md-6 item">
                <h4>Acer Predator XB241Hbmipr</h4>
                <img class="" src="Images/acer-predator-xb241hbmipr-showmodel.jpg" alt="" width="240" height="240">
                <h5>€ 379,00</h5>
                <p><a class="btn btn-success" href="login.php" role="button">In Winkelmandje</a></p>
            </div>
        </div><br>
